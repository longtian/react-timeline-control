...
var Control = function (_Component) {
  ...
  _createClass(Control, [{
    ...
    value: function handlePlayClick() {
      clearInterval(this._timer);
      var duration = this.state.duration == -1 ? this.props.default_duration : this.state.duration;
      var to_ts = now();
      var from_ts = now() - duration;
      this.setState({
        duration: duration,
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { className: 'btn btn-primary btn-sm', disabled: this.state.playing, onClick: this.handlePlayClick.bind(this) },
            _react2.default.createElement('i', { className: 'glyphicon glyphicon-play' })
          ),
          _react2.default.createElement(
            'button',
            { className: 'btn btn-primary btn-sm', disabled: !this.state.playing, onClick: this.handlePauseClick.bind(this) },
